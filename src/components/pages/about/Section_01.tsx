          ...
          <ul className={s['content-section']}>
            <li>
              ...
              <div className={s['about-content']}>
                안녕하세요, 기술과 디자인을 자연스럽게 잇는 프론트엔드 개발자
                유강산입니다.
                <br />
                저는 지난 3년간 스타트업 환경에서 Next.js와 React를 사용해 실제
                서비스를 만들고 운영해 왔습니다. 소규모 팀에서의 경험으로
                사용자가 직접 만나는 웹 화면부터 내부 직원들이 쓰는 관리자
                페이지까지, 프론트엔드의 거의 모든 영역을 직접 부딪히며
                경험했습니다. 서비스가 처음 기획되어 세상에 나오고 운영되는 전체
                ...
                덕분에 편안하게 소통하는 방법을 잘 알고 있습니다. 일을 하다 보면
                기술적으로 구현하기 어렵거나 복잡한 상황이 생기곤 하는데, 저는
                이런 문제들을 개발을 모르는 동료들도 쉽게 이해할 수 있도록
                일상적인 언어로 풀어서 설명하는 데 익숙합니다. 언제나 꼼꼼하게
                코드를 작성하는 기본기를 바탕으로, 동료들과 부드럽게 소통하며 더
                좋은 서비스를 함께 만들어 가는 개발자가 되겠습니다.
              </div>
            </li>
          </ul>
        </div>
